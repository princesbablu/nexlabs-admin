...
const UpdateArea = () => {
    ...
    return (
        <div className="container relative z-10">
            ...
            <div className="h-[150px] flex items-center px-7 py-8 rounded-xl bg-[#0B0F07]">
                <div className="flex justify-between w-full">
                                    ...
                                    >
                                        ...
                                        <defs>
                                            <clippath id="clip0_208_2106">
                                                <rect x="0.00585938" width={24} height={24} rx={4} fill="white" />
                                            </clippath>
                                        </defs>
                                    </svg>
                            ...
                            <div className="relative flex items-start justify-start gap-2">
                                ...
                                <div className="relative flex items-start justify-start gap-1">
                                    ...
                                    >
                                        ...
                                        <defs>
                                            <clippath id="clip0_86_2797">
                                                <rect width={10} height={10} fill="white" transform="translate(3.0249 3.01855)" />
                                            </clippath>
                                        </defs>
                                    </svg>
                                    <svg
                                    ...
                                    >
                                        ...
                                        <defs>
                                            <clippath id="clip0_86_2800">
                                                <rect width={10} height={10} fill="white" transform="translate(3.06299 3.01855)" />
                                            </clippath>
                                        </defs>
                                    </svg>
                                </div>
                    ...
                    <div className="relative flex flex-col items-end justify-start gap-2 drop-shadow">
                        <div className="absolute top-0 left-0 z-10 w-full h-full"></div>
                        <div className="absolute right-0 z-20 flex flex-col items-end -translate-y-1/2 top-1/2">
