                    ...
                    <div className="flex items-center gap-3 ml-auto">
                        <div className='relative cursor-pointer group'>
                            <svg
                                ...
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                                className="flex-grow-0 flex-shrink-0 rounded w-11 h-11"
                                preserveAspectRatio="none"
                            >
                                <rect
                                    x="0.878906"
                        ...
                        <div className="bg-gradient-to-tl from-[#00ADEF] to-[#8AC640] p-px rounded-lg cursor-pointer hover:from-[#8ac640] hover:to-[#00adef] group">
                            <div className="h-[42px] rounded-lg bg-body flex items-center justify-center px-4 gap-3 relative">
                                <Image src={curLogo} alt="" priority />

                                <div className="h-6 w-0.5 bg-[#171F10]"></div>
                        ...
                        <div>
                            <div className="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 relative gap-1.5 px-5 py-2.5 rounded-lg bg-gradient-to-tl from-[#00adef] to-[#8ac640] cursor-pointer hover:from-[#8ac640] hover:to-[#00adef]">
                                <svg
                                    width={25}
                                    height={16}
                                    viewBox="0 0 25 16"
